...
const RoutineList = ({
    ...
    <ul className='flex flex-column'>
        <PopUp visibility={visibility} setVisibility={setVisibility} courseCode={courseCode} realSubjects={realSubjects} />
        <div className='table'>
...
const PopUp = ({ visibility, setVisibility, courseCode, realSubjects }) => {
    ...
    return realSubjects.includes(courseCode) && (
        <div className="popup flex flex-column space-between" style={{ visibility }}>
